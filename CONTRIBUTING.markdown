...
Ratchet loves to welcome your contributions. There are several ways to help out:
...
* Contribute to the [documentation](https://github.com/WyriHaximus/Ratchet/tree/master/docs)
...
Ratchet tests requires [PHPUnit](http://www.phpunit.de/manual/current/en/installation.html)
3.5 or higher. To run the testcases locally use the following command:

    ./lib/Cake/Console/cake test Ratchet AllRatchet

To run the sniffs for CakePHP coding standards

    phpcs -p --extensions=php --standard=CakePHP ./app/Plugin/Ratchet
...
* [Bug tracker](https://github.com/WyriHaximus/Ratchet/issues)
